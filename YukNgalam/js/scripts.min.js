...
$(function(){$(".js-filter-drag-items").on("click",function(t){t.preventDefault();var e=$(this).data("category"),i=$(this).text();$(".js-destination-filter-btn-label").text(i),$(".destinations .drag-item").hide().filter(function(){return""===e||e===$(this).data("category")}).show()}),$(".toggle_menu").click(function(){$(this).toggleClass("is-active"),$(".main_menu").slideToggle()}),$(".main_menu a, .go_up").mPageScroll2id({scrollSpeed:500}),$("#datepicker1").datepicker({dateFormat:"dd/mm/yy"}),$("#datepicker2").datepicker({dateFormat:"dd/mm/yy"})});