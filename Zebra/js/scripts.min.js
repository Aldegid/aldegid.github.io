...
/************************/
	...
	$(".categories").waypoint(function() {
		...
		$(".categories_item_even").addClass('animated fadeInDown');
		...
		$(".categories_item, .categories h2").addClass('animated fadeInUp');
...
/*       *****Vivus start*****       */
 	...
 	var myCallback = function () {
 		$(".mySVG").addClass("white");
 	};

  var els= document.getElementsByClassName("mySVG");

    for (var i = els.length - 1; i >= 0; i--) {
      new Vivus(els[i], {duration: 150, type: 'async' }, myCallback);
    }
